...
const defaultSettings: ClockSettings = {
  ...
  showParticles: true,
  worldClocks: [
    { id: '1', name: 'Chennai', timezone: 'Asia/Kolkata' },
    { id: '2', name: 'Coimbatore', timezone: 'Asia/Kolkata' },
    { id: '3', name: 'Madurai', timezone: 'Asia/Kolkata' },
    { id: '4', name: 'Tiruchirappalli', timezone: 'Asia/Kolkata' },
  ],
  showWorldClock: true,
  showTimer: true,
  showStopwatch: true,
